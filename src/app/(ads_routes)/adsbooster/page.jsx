    ...
    <div className='md:px-20 px-6 pt-28 onepage'>
        <div className=''>
            ...
            <Image className=' block m-auto mt-10'  src={'/basket.gif'} width={100} height={100} alt="hero"/>
              <p className='text-[20px] text-center text-slate-100 leading-none mt-3 font-thin'>We Have Received Your Request For The <span className=''></span> <br/> <span className='text-[30px] font-extrabold '>Adsbooster<br/></span></p>
