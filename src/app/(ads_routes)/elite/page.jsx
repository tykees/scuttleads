  ...
  return (
    <div className='md:px-20 px-6 pt-28 onepage'>
        <div className=''>
            ...
            <Link href={"https://paystack.com/pay/ykk41pp0lj"}>  <Button variant="outline" className="bg-transparent border border-primary md:w-[500px] w-[350px] text-[23px] h-[50px] text-primary">Pay  N207,400 With PayStack</Button></Link>
              <Button variant="outline" className="text-black mt-4 border border-slate-700 md:w-[500px] w-[350px] text-[23px] h-[50px] bg-primary">Transfer  N207,400</Button>
              </div>
            </div>
        </div>
    </div>
