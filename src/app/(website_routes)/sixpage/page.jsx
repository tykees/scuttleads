  ...
  return (
    <div className='md:px-20 px-6 pt-28 onepage'>
        <div className=''>
            ...
            <Link href={"https://paystack.com/pay/833l0pag0l"}>  <Button variant="outline" className="bg-transparent border border-primary md:w-[500px] w-[350px] text-[23px] h-[50px] text-primary">Pay  N80,000 With PayStack</Button></Link>
