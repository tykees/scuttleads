  ...
  return (
    <div>
        <div className='container mx-auto'>
            ...
            <p className='mt-6'>Browse the Marketplace, educational videos, and customer stories<br/>to find what you need to succeed with Webflow.</p>
            ...
            <div className='w-[300px] p-4 bg-inherit border my-1 hover:shadow-xl transition-all border-slate-300 h-[360px] shadow-md rounded-lg'>
                   ...
                   <p className='text-slate-900 text-left text-xl font-bold'>Ads Buckets</p>
