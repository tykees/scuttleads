    ...
    <div className='px-20 hero'>
        <div className='flex pt-32 justify-between items-center'>
            <div>
              ...
              <p className='w-[500px] mt-5 text-slate-400'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae beatae rem voluptatum nesciunt soluta architecto obcaecati voluptate neque, accusamus sint ducimus odit amet fugit necessitatibus voluptatem ullam aspernatur officiis iure.</p>
              <div className='flex gap-8 mt-5'>
              <Button variant="outline" className="text-black border border-slate-700 w-[150px] h-[50px] bg-primary">Get in Touch</Button>
