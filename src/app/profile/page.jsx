  ...
  return (
    <div>
        <div className='pt-30'>
          ...
          <div className='bg-white border m-auto  rounded-lg w-[700px] h-[550px]'>
            <div className='flex justify-center items-center'>
              ...
              <div className='flex justify-center  text-green-600 items-center gap-2 pr-6'>
                <TiMessages className='text-[25px]' />
                <p>Message</p>
              </div>
            </div>
              ...
              <div className='grid grid-cols-5 px-5 pt-5 items-center gap-3'>
              
              {
                userEnrolledAds.map((item, index)=>(
                  <div key={index}>
                    <div className='border bg-slate-100 text-slate-400 min-w-[110px] rounded-md text-center'>
                   {item.name}
                 </div>
                  </div>
                ))
